...
public class faceDetectView extends DynamicWebPage {
		
    public faceDetectView(DatabaseInterface db, FileStoreInterface fs) {
		super(db, fs);
    ...
    {
        if(toProcess.path.equalsIgnoreCase("facedetect/playCanvasStart"))
        { 	  	
            ...
            JSONObject center = imgTile(0, yHeight, -5, faceDetectIcon);
        ...
        else if(toProcess.path.equalsIgnoreCase("facedetect/playCanvasUpdate"))
        {  	
        	JSONObject responseData = new JSONObject();
            JSONArray entities = new JSONArray();
