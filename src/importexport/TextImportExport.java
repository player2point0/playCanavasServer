...
public class TextImportExport 
{
    ...
    public static String readline(importexport.stream.BufferedReader bis)
    {
    	boolean empty = false;
    	String result = "";
    	try
    ...
    public static String loadTextFileASString(File file)
    {
    	try
    	{
    	String result = new String(loadTextFile(file.toURL()));
    	return result;
    	}catch(Exception e)
    	{
    		System.out.println(e.toString());
    ...
    public static String loadTextFileASString(String filepath)
    {
    	String result = new String(loadTextFile(filepath));
    	return result;
    }
    ...
    public static char[] loadTextFile(String filepath)
    {
		try
		{
			return loadTextFile((new File(filepath)).toURL());
		}
		catch(Exception e)
		{
			System.out.println(e.toString());
