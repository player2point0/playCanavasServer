...
public class GeneralMatrixDouble {
	...
	public void set3DBasis(double[] basis)
	{
		value[4*0+0] = basis[3*0+0];
		value[4*0+1] = basis[3*0+1];
		value[4*0+2] = basis[3*0+2];

		value[4*1+0] = basis[3*1+0];
		value[4*1+1] = basis[3*1+1];
		value[4*1+2] = basis[3*1+2];

		value[4*2+0] = basis[3*2+0];
		value[4*2+1] = basis[3*2+1];
		value[4*2+2] = basis[3*2+2];
	}
